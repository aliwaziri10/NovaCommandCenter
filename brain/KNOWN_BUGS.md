...
- **Supervisor workflow (supervisor.yml) not yet observed in a real run** — added this session (2026-08-09), logic not yet battle-tested against a genuine stuck video or a genuinely stale issue.
- **Content-policy retry port not yet confirmed committed or fired for real** — added this session (2026-08-09) to generate_videos.py, handed to Ali as a full-file edit.
